...
public class SICOExceptions extends Exception {
       ...
       */
       ...
       public SICOExceptions(String pvcMensajeParaUsuario){
              this.setMensajeParaUsuario(pvcMensajeParaUsuario);
              }
          /**
           * Constructor que se encarga de asignar el valor del tipo de exception, el mensaje para el usuario y el mensaje para imprimir
           * en consola para el desarrollador
           * @param pvnTipoException
           * @param pvcMensaje
           */
          
          public SICOExceptions(int pvnTipoException, String pvcMensaje){
          ...
          public SICOExceptions(int pvnTipoException, String pvcMensaje, int pvnCodigoError) {
           ...
           * @param pvnBD
           */
          public SICOExceptions(int pvnTipoException, String pvcMensaje, int pvnCodigoError, int pvnBD) {
